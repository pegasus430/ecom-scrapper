...
# Aerospike should be built from source for alpine, but default setup is buggy
# when run in docker container. This is copy with the bug fixed.
...
def resolve_c_client(lua_src_path):
    ...
    call('sync') # custom fix, prevents "Text File Busy" Error
